...
const Quote = () => {
  return (
    <div className='w-full h-[568px] sm:h-full flex-col bg-gray-50 py-24 sm:py-5 px-24 sm:px-5 flex justify-center items-center text-center'>
        ...
        <h1 className='text-gray-800 font-bold text-5xl sm:text-3xl my-10'>We’ve been with unicraft to kick start every new project and can’t imagine working without it.</h1>
