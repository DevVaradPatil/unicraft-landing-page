...
const HowItWorks = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-gray-800 text-5xl sm:text-4xl font-bold">
          How It Works
        </h1>
      ...
      <div
        ref={ref2}
        className="flex sm:flex-col sm:gap-20 sm:mt-20 text-center justify-evenly w-full items-center"
      >
        <motion.div
        ...
        >
          ...
          <h2 className="text-gray-800 text-4xl sm:text-3xl font-extrabold">
            Subscribe
          </h2>
